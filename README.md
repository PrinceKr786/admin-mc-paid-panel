...
1. Create a Firebase project: **primuim-panel-v1**
...
```js
apiKey: "AIzaSyBYXE3V9k6nf7Dp6n2UlfmjxWPS8E9_LOU",
databaseURL: "https://primuim-panel-v1-default-rtdb.firebaseio.com",
projectId: "primuim-panel-v1"
```
